...
public interface SessionRepository extends JpaRepository<SessionEntity, Long> {
	...
	Optional<SessionEntity> findBySessionUuid(String uuid);
    ...
    Optional<SessionEntity> findFirstByStatus(String status);
    
    Optional<SessionEntity> findByStudentAndExam(StudentEntity student, ExamEntity exam);
    
    @Query("""
    	    SELECT s FROM SessionEntity s
    	    WHERE s.status = 'ACTIVE'
    	""")
    	List<SessionEntity> findAllActive();
}
